...
class FocusBrandCategory extends StatefulWidget {
  const FocusBrandCategory({Key? key}) : super(key: key);

  @override
  State<FocusBrandCategory> createState() => _FocusBrandCategoryState();
}

class _FocusBrandCategoryState extends State<FocusBrandCategory> {
  int _selected = 0;
