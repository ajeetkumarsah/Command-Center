...
class CoverageCategory extends StatefulWidget {
  const CoverageCategory({Key? key}) : super(key: key);

  @override
  State<CoverageCategory> createState() => _CoverageCategoryState();
}

class _CoverageCategoryState extends State<CoverageCategory> {
  int _selected = 0;
