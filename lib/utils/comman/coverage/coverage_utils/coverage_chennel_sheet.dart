...
class CoverageChannelSheet extends StatefulWidget {
  final List list;
  ...
  const CoverageChannelSheet(
      {Key? key,
        required this.list,
        required this.divisionList,
        required this.siteList,
        required this.branchList,
        required this.selectedGeo, required this.onPressed, required this.channelList, required this.onChannelTap})
      : super(key: key);

  @override
  State<CoverageChannelSheet> createState() => _CoverageChannelSheetState();
}

class _CoverageChannelSheetState extends State<CoverageChannelSheet> {
  int current_index = 1;
  int _selected = 0;
  List newItems = [];
  List<String> items = ['Channel'];
                                      ...
                                      setState(() {
                                        ...
                                        // if(_selected == 0){
                                          SharedPreferencesUtils.setString(
                                              'coverageChannelD', items[index].toLowerCase());
                                        // }
    // else if (_selected == 1){
                                        //   SharedPreferencesUtils.setString(
                                        //       'coverageChannelC', items[index].toLowerCase());
                                        // }else if (_selected == 2){
                                        //   SharedPreferencesUtils.setString(
                                        //       'coverageChannelS', items[index].toLowerCase());
                                        // }
                                                    ...
                                                    Checkbox(
                                                      ...
                                                      onChanged: (isChecked) {
                                                        setState(() {
                                                          ...
                                                          // if(_selected == 0){
                                                          SharedPreferencesUtils.setString("coverageChannelDS", widget.channelList[index]);
                                                          // }else if (_selected == 1){
