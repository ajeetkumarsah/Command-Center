...
class RetailingCategory extends StatefulWidget {
  const RetailingCategory({
    Key? key,
  }) : super(key: key);

  @override
  State<RetailingCategory> createState() => _RetailingCategoryState();
}

class _RetailingCategoryState extends State<RetailingCategory> {
  ...
  late List<DataTableModel> rowDataCategory;

  @override
  void initState() {
    rowDataCategory = DataTableModel.getRowsDataCategory();
    postRequest(context);
    super.initState();
  }
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: ListView
                                                                    ...
                                                                    itemBuilder:
                                                                        (BuildContext context,
                                                                        index) {
                                                                      SharedPreferencesUtils.setString('mobileCategoryDivision', items[_selected].toLowerCase());
                                                                      return Container(
                                                                        height:
                                                                        45,
                                                                        ...
                                                                        ListTile(
                                                                          ...
                                                                          onTap: () {
                                                                            setState(() {
                                                                              ...
                                                                              SharedPreferencesUtils.setString('mobileCategoryDivision', items[index].toLowerCase());
                                                                            });
                                                                          },
                                                                        ),
                                                                      );
                                                          ...
                                                          children: [
                                                            ...
                                                            Expanded(
                                                                ...
                                                                TextButton(
                                                                    onPressed:
                                                                        () {
                                                                      print(SharedPreferencesUtils.getString('mobileCategoryDivision'));
                                                                      print(SharedPreferencesUtils.getString('mobileCategorySite'));
                                                                      // Navigator.of(context)
                                                                      //     .pop(true);
                                                                    },
                                                                    child:
                              ...
                              return DataRow(
                                ...
                                cells: [
                                  DataCell(SizedBox(
                                      width: 60,
                                      child: Text(
                                        '${dataListRetailingChannel[0][0]['table'][0]['data'][index]['Category']}',
