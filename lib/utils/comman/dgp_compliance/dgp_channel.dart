...
class DGPChannel extends StatefulWidget {
  const DGPChannel({Key? key}) : super(key: key);

  @override
  State<DGPChannel> createState() => _DGPChannelState();
}

class _DGPChannelState extends State<DGPChannel> {
