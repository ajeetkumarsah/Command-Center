...
class DGPTrends extends StatelessWidget {
  final Function(bool) onExpansionChanged;
  final bool isExpanded;
  const DGPTrends({Key? key, required this.onExpansionChanged, required this.isExpanded}) : super(key: key);
