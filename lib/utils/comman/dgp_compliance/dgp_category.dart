...
class DGPCategory extends StatefulWidget {
  const DGPCategory({Key? key}) : super(key: key);

  @override
  State<DGPCategory> createState() => _DGPCategoryState();
}

class _DGPCategoryState extends State<DGPCategory> {
  int _selected = 0;
