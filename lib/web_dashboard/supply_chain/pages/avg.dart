...
import 'package:command_centre/web_dashboard/supply_chain/custom_widget/button_widget.dart';
import 'package:command_centre/web_dashboard/supply_chain/utils/avgMiddleSection.dart';
...
import '../supply_chain_provider/transportation_provider.dart';

class AvgLandingPAge extends StatefulWidget {
  const AvgLandingPAge({super.key});

  @override
  State<AvgLandingPAge> createState() => _AvgLandingPAgeState();
}

class _AvgLandingPAgeState extends State<AvgLandingPAge> {
        ...
        body: Stack(children: [
          ...
          Row(
            children: [
              ...
              const DrawerAlerts(indexNew: 1),
              // const SizedBox(height: 150, width: 600, child: LineChartSample()),
            ],
          ),
        ]),
      ),
