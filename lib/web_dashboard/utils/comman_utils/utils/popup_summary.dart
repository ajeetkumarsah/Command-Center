...
class DivisionWebRetailingSheet extends StatefulWidget {
  final List list;
  ...
  const DivisionWebRetailingSheet(
      {Key? key,
        required this.onTap,
        required this.list,
  ...
  @override
  State<DivisionWebRetailingSheet> createState() => _DivisionWebRetailingSheetState();
}

class _DivisionWebRetailingSheetState extends State<DivisionWebRetailingSheet> {
  int current_index = 0;
  int _selected = 0;
