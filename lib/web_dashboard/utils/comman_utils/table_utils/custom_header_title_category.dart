...
class CustomHeaderTitleCategory extends StatelessWidget {
  ...
  const CustomHeaderTitleCategory({super.key, required this.dataList, required this.selectedIndexLocation, required this.per, required this.points, required this.target});
