...
import 'package:command_centre/web_dashboard/utils/drawer_container/deep_dive_container/gp_Container/gp_web_summary.dart';
...
class GPContainerWeb extends StatefulWidget {
  final String title;
  ...
  const GPContainerWeb(
      ...
      required this.categoryApply, required this.onClosedTap, required this.selectedMonthList, required this.onTapMonthFilter, required this.onTap1, required this.onTap2, required this.onTap3, required this.onTap4, required this.selectedIndex1, required this.onRemoveFilterTap, required this.onRemoveFilterCategory, required this.selectedItemValueCategory, required this.selectedItemValueBrand, required this.selectedItemValueBrandForm, required this.selectedItemValueBrandFromGroup, required this.onTapChannelFilter, required this.onTapRemoveFilter, required this.onTapContainer, required this.onApplyRetailingSummary, required this.onRemoveGeoPressed, required this.listRetailingDataListCoverage, required this.onMonthChangedDefault, required this.onApplySummaryDefaultMonth, required this.tryAgain, required this.tryAgain1, required this.tryAgain2});

  @override
  State<GPContainerWeb> createState() => _GPContainerWebState();
}

class _GPContainerWebState extends State<GPContainerWeb> {
  int selectedIndex = 1;
  ...
  Widget build(BuildContext context) {
    ...
    return dailyReport == false
                                              ...
                                              child: Column(
                                                children: [
                                                  HeaderWebCard(
                                                    ...
                                                    onDateSelected: () {},
                                                    elName: 'Golden Points',
                                                  ),
                                                  GPWebContainer(
                                                    elName: 'Golden Points',
                                                    gpDataList: widget.listRetailingDataListCoverage,
                                                  )
        ...
        : Expanded(
            ...
            categoryApply: widget.categoryApply, onClosedTap: widget.onClosedTap, selectedMonthList: widget.selectedMonthList,
              onTapMonthFilter: widget.onTapMonthFilter, onTap1: widget.onTap1, onTap2: widget.onTap2, onTap3: widget.onTap3,
              onTap4: widget.onTap4, selectedIndex1: widget.selectedIndex1, onRemoveFilterTap: widget.onRemoveFilterTap,
              onRemoveFilterCategory: widget.onRemoveFilterCategory, selectedItemValueCategory: widget.selectedItemValueCategory,
              ...
              tryAgain: widget.tryAgain, tryAgain1: widget.tryAgain1, tryAgain2: widget.tryAgain2,
          ));
  }
}
