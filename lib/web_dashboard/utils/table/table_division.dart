        ...
        children: [
          Container(
              ...
              child: ListView.builder(
                  shrinkWrap: true,
                  itemCount: widget.newDataList[0]['division'].length,
                  itemBuilder: (context, siteIndex) {
                    var sites = widget.newDataList[0]['division'][siteIndex];
                    return ListTileTheme(
                      ...
                      child: ExpansionTile(
                        ...
                        //     .leading,
                        collapsedBackgroundColor: siteIndex % 2 == 0
                            ? MyColors.dark500
                            : MyColors.dark400,
                        backgroundColor: siteIndex % 2 == 0
                            ? MyColors.dark500
                            : MyColors.dark400,
                        title: SizedBox(
                          height: 40,
                          child: Row(
                            ...
                            children: [
                              ...
                              TextHeaderWidgetWithIcon(
                                title: "${sites['filter_key']}",
                                align: TextAlign.start,
                                isRequired: false,
                                isExpanded: sheetProvider.isExpanded,
                              ),
                              const SizedBox(
                                width: 3,
                              ),
                              ...
                              SizedBox(
                                width: sheetProvider.isExpandedBranch == true
                                    ? 3
                                    : 0,
                              ),
                              Consumer<SheetProvider>(
                              ...
                              SizedBox(
                                width: sheetProvider.isExpanded == true ? 3 : 0,
                              ),
                              Consumer<SheetProvider>(
                                builder: (context, state, child) {
                                  return Padding(
                              ...
                              SizedBox(
                                width: sheetProvider.isExpandedChannel == true
                                    ? 3
                                    : 0,
                              ),
                              Consumer<SheetProvider>(
                              ...
                              child: Column(
                                children: [
                                  ListView.builder(
                                      shrinkWrap: true,
                                      itemCount: widget
                                          .newDataList[0]['division'][siteIndex]
                                              ['Site']
                                          .length,
                                      itemBuilder: (context, branchIndex) {
                                        var branches = widget.newDataList[0]
                                                ['division'][siteIndex]['Site']
                                            [branchIndex];
                                        // print(
                                        //     branches);
                                        return ListTileTheme(
                                                                ...
                                                                title: SizedBox(
                                                                  ...
                                                                  child: Row(
                                                                    children: [
                                                                      ...
                                                                      SizedBox(
                                                                        width: sheetProvider.isExpandedChannel ==
                                                                                true
                                                                            ? 3
                                                                            : 0,
                                                                      ),
