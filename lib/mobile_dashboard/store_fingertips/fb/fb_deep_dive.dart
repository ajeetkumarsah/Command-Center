...
class FBDeepDiveScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: GetBuilder<StoreFBController>(
        init: StoreFBController(storeFBRepo: Get.find()),
        builder: (ctlr) {
          return Scaffold(
            backgroundColor: AppColors.bgLight,
            body: !ctlr.isLoading && ctlr.storeFBCategoryModel.isNotEmpty
                    ...
                    child: Column(
                      children: [
                        Container(
                          ...
                          child: Column(
                            children: [
                              Image.asset("assets/png/Group 35.png",
                                  height: 31),
                          ...
                          child: Column(
                            children: [
                              ...
                              Expanded(
                                child: LineChart(
                                  LineChartData(
                                    maxY: ctlr.storeFBTrendsModel?.yMax
                                            ?.toDouble() ??
                                        0.0,
                                    // maxX: 6,
                                    lineBarsData: [
                          ...
                          child: Row(
                            children: [
                              ...
                              Container(
                                ...
                                child: Center(
                                    child: SvgPicture.asset(SvgFiles.info)),
                              ),
                            ],
                          ),
                        ),
