...
import 'package:command_centre/web_dashboard/utils/comman_utils/division_supply_chain.dart';
import 'package:command_centre/web_dashboard/utils/comman_utils/drawer_alerts.dart';
import 'package:command_centre/web_dashboard/utils/comman_utils/drawer_widget_supply_chain.dart';
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                                      ...
                                      return InkWell(
                                        onTap: () async{
                                          ...
                                          if (movement == "Both") {
                                            ...
                                            await postRequest(context, [], [], [], [], [], provider.movementFilter!, []);
                                          }
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 24, top: 16, right: 22),
                          child: Row(
                                      ...
                                      child: Align(
                                        ...
                                        child: MenuWidget(
                                          ...
                                          onFilterClick: () async {
                                            ...
                                            await postRequest(context, [], provider.catFilter!, provider.sbfFilter!, provider.destinationFilter!,
                                            ...
                                            actions: [
                                              ElevatedButton(
                                                ...
                                                onPressed: () async {
                                                  ...
                                                  Navigator.of(context).pop();
                                                  await postRequest(context, [date], [], [], [], [], '', []);
                                                  provider.setLoad(false);
                                                  // your code
                                                },
                                              ),
                                  ...
                                  child: Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              provider.filterDate == ''? 'YTD': '${provider.filterDate}',
                                              style: const TextStyle(
                                                fontSize: 13,
                                              ),
                                            ),
