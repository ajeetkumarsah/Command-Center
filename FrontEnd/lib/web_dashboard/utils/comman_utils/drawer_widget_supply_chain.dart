      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
              child:  widget.menuData.isEmpty?const Center(child: SizedBox(
                  width: 30,height: 30,
                  child: CircularProgressIndicator())):  ListView.separated(
                  separatorBuilder: (context, index) => Container(),
                  itemCount: widget.menuData[0]['menuData'].length,
                    ...
                    return InkWell(
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          width: size.width,
                          decoration: BoxDecoration(
                            color: selectedIndex == index ? MyColors.whiteColor : Color(0xffFFFFFF).withOpacity(0.45),
                            borderRadius: BorderRadius.circular(10.0),
                          ...
                          child: Align(
                              ...
                              child: Padding(
                                padding: const EdgeInsets.only(top: 20, left: 14, bottom: 24),
                                child: index == 0
                                    ? Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                            ...
                                            child: Row(
                                              children: [
                                                provider.load ? Container(
                                                    height : 20,
                                                    width: 20,
                                                    child: const CircularProgressIndicator()): Text(
                                                      ...
                                                      children: [
                                                        Tooltip(
                                                          ...
                                                          child: Text(
                                                            ...
                                                            textAlign: TextAlign.end,
                                                            style: TextStyle(
                                                                color: index == 1 || index == 2 ? const Color(0xff00C108) : const Color(0xffF10000),
                                                                fontFamily: fontFamily,
                                                                fontSize: 18),
                                                          ),
                                                        ),
                                                        Icon(
                                                          index == 1 || index == 2 ? Icons.arrow_drop_down : Icons.arrow_drop_up,
                                                          color: index == 1 || index == 2 ? Colors.green : Colors.red,
                                                          size: 30,
                                                        ),
                                                      ],
                                                    ),
                                                        ...
                                                        children: [
                                                          ...
                                                          Row(
                                                            children: [
                                                              Text(
                                                                '${widget.menuData[0]['menuData'][index]['percentage']}',
                                                                style: const TextStyle(color: Color(0xff00C108), fontFamily: fontFamily, fontSize: 18),
                                                              ),
                                                              const Icon(
                                                                Icons.arrow_drop_up,
