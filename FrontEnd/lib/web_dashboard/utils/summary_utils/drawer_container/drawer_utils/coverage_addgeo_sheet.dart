...
class CoverageGeoDivisionWebSheet extends StatefulWidget {
  final List list;
  ...
  const CoverageGeoDivisionWebSheet(
      {Key? key,
        required this.onTap,
        required this.list,
  ...
  @override
  State<CoverageGeoDivisionWebSheet> createState() => _CoverageGeoDivisionWebSheetState();
}

class _CoverageGeoDivisionWebSheetState extends State<CoverageGeoDivisionWebSheet> {
  int current_index = 0;
  int _selected = 0;
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        setState(() {
                                          ...
                                          //   if(items[index] == 'All India'){
                                          //     SharedPreferencesUtils.setString(
                                          //         'webDistributionDivision',allIndia);
                                          //   }else{
                                          //     SharedPreferencesUtils.setString(
                                          ...
                                          // } else {
                                            SharedPreferencesUtils.setString(
                                                'coverageAddGeoDivision', allIndia);
                                          // }
                                        });
                                      },
                                      child: Padding(
                          ...
                          child: Column(
                            children: [
                              Padding(
                                ...
                                child: items[_selected] == 'All India' || items[_selected] == 'Division' ?Container():  SizedBox(
                                    height: 28,
                                    child: Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: TextField(
                                        onChanged: (value) {
                                          if(items[_selected] == 'Cluster'){
                                            filterItems(value);
                                          }else{
