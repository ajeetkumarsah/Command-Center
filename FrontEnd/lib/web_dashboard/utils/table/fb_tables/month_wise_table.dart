...
class FBTableDataAllMonthWise extends StatefulWidget {
  final List newDataList;
  final String keyName1;
  final String keyName2;
  final String keyName3;

  const FBTableDataAllMonthWise({
    super.key,
    required this.newDataList, required this.keyName1, required this.keyName2, required this.keyName3,
  });

  @override
  State<FBTableDataAllMonthWise> createState() => _FBTableDataAllMonthWiseState();
}

class _FBTableDataAllMonthWiseState extends State<FBTableDataAllMonthWise> {
  @override
