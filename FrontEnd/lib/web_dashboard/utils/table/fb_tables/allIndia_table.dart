                          ...
                          child: Row(
                            children: [
                              TextHeaderWidgetWithIcon(
                                ...
                                isRequired: false,
                                isExpanded: sheetProvider.isExpandedDivision,
                              ),
                              const SizedBox(
                                width: 3,
                              ),
                              ...
                              Padding(
                                ...
                                child: TextHeaderWidget(
                                  title: '${coverage1[widget.keyName1]}',
                                  //Billing Percentage
                                                                    ...
                                                                    Column(
                                                                      children: [
                                                                        ListView
                                                                            ...
                                                                            shrinkWrap: true,
                                                                            itemCount: widget
                                                                                .newDataList[index]['division'][siteIndex]['Site'][branchIndex]['Branch']
                                                                                .length,
                                                                            itemBuilder: (
                                                                                context,
                                                                                branch2Index) {
                                                                              var branches = widget
                                                                                  .newDataList[index]['division'][siteIndex]['Site'][branchIndex]['Branch'][branch2Index];
                                                                              // print(
                                                                              //     branches);
                                                                              return ListTileTheme(
                                                                                dense: true,
                                                                                ...
                                                                                child: ExpansionTile(
                                                                                  ...
                                                                                  // ListTileControlAffinity
                                                                                  //     .leading,
                                                                                  collapsedBackgroundColor: branch2Index %
                                                                                      2 ==
                                                                                      0
                                                                                      ? MyColors
                                                                                      .dark500
                                                                                        ...
                                                                                        child: Column(
                                                                                          children: [
                                                                                            ListView
                                                                                                ...
                                                                                                shrinkWrap: true,
                                                                                                itemCount: widget
                                                                                                    .newDataList[index]['division'][siteIndex]['Site'][branchIndex]['Branch'][branch2Index]['Channel']
                                                                                                    .length,
                                                                                                itemBuilder: (
                                                                                                    context,
                                                                                                    channelIndex) {
                                                                                                  var branches = widget
                                                                                                      .newDataList[index]['division'][siteIndex]['Site'][branchIndex]['Branch'][branch2Index]['Channel'][channelIndex];
                                                                                                  // print(
                                                                                                  //     branches);
                                                                                                  return ListTileTheme(
                                                                                                    dense: true,
                                                                                                    ...
                                                                                                    child: ExpansionTile(
                                                                                                      ...
                                                                                                      // ListTileControlAffinity
                                                                                                      //     .leading,
                                                                                                      collapsedBackgroundColor: channelIndex %
                                                                                                          2 ==
                                                                                                          0
                                                                                                          ? MyColors
                                                                                                          .dark600
                                                                                                            ...
                                                                                                            child: Column(
                                                                                                              children: [
                                                                                                                ListView
                                                                                                                    ...
                                                                                                                    shrinkWrap: true,
                                                                                                                    itemCount: widget
                                                                                                                        .newDataList[index]['division'][siteIndex]['Site'][branchIndex]['Branch'][branch2Index]['Channel'][channelIndex]['SubChannel']
                                                                                                                        .length,
                                                                                                                    itemBuilder: (
                                                                                                                        context,
                                                                                                                        subChannelIndex) {
                                                                                                                      var branches = widget
                                                                                                                          .newDataList[index]['division'][siteIndex]['Site'][branchIndex]['Branch'][branch2Index]['Channel'][channelIndex]['SubChannel'][subChannelIndex];
                                                                                                                      // print(
                                                                                                                      //     branches);
                                                                                                                      return Container(
                                                                                                                        color: subChannelIndex %
                                                                                                                            2 ==
                                                                                                                            0
                                                                                                                            ? MyColors
                                                                                                                            .dark500
