...
class CoverageTableTabDivision extends StatefulWidget {
  final List newDataList;
  final String keyName1;
  final String keyName2;
  final String keyName3;

  const CoverageTableTabDivision({
    super.key,
    required this.newDataList, required this.keyName1, required this.keyName2, required this.keyName3,
  });

  @override
  State<CoverageTableTabDivision> createState() => _CoverageTableTabDivisionState();
}

class _CoverageTableTabDivisionState extends State<CoverageTableTabDivision> {
  @override
