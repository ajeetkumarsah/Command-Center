...
class CoverageTableTabSite extends StatefulWidget {
  final List newDataList;
  final String keyName1;
  final String keyName2;
  final String keyName3;

  const CoverageTableTabSite({
    super.key,
    required this.newDataList, required this.keyName1, required this.keyName2, required this.keyName3,
  });

  @override
  State<CoverageTableTabSite> createState() => _CoverageTableTabSiteState();
}

class _CoverageTableTabSiteState extends State<CoverageTableTabSite> {
  @override
                                ...
                                children: <Widget>[
                                  ...
                                  SingleChildScrollView(
                                    child: Padding(
                                      ...
                                      child: Column(
                                        children: [
                                          (widget.newDataList[0]['division']).isEmpty?Container(): ListView.builder(
                                              shrinkWrap:
                                              true,
                                              itemCount: widget
                                                  .newDataList[
