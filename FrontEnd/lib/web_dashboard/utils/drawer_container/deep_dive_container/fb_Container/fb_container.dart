...
class FBContainerWeb extends StatefulWidget {
  ...
  const FBContainerWeb(
      ...
      required this.selectedIndex1, required this.onRemoveFilterCategory, required this.selectedCategoryList, required this.selectedItemValueCategory, required this.selectedItemValueBrand, required this.selectedItemValueBrandForm, required this.selectedItemValueBrandFromGroup, required this.onTapChannelFilter});
