                ...
                child: SingleChildScrollView(
                  child: Padding(
                    padding: const EdgeInsets.only(
                        left: 13.0, right: 13.0, bottom: 13.0, top: 10),
                    child: Row(children: [
                      SizedBox(
                        // width: 90,
                        child: Theme(
                          ...
                          child: DataTable(
                            ...
                            columns: [
                              DataColumn(
                                ...
                                numeric: true,
                                tooltip: 'Unique id for rows',
                              ),
                            ],
                            rows:
                                List.generate(rowDataCategory.length, (index) {
                              final item = rowDataCategory[index];
                              return DataRow(
                                color: index % 2 == 0
                                ...
                                cells: [
                                  DataCell(SizedBox(
                                      width: 70, child: Text(item.name, style: ThemeText.tableHeaderText,)))
                                ],
                              );
                            }),
                          ),
  ...
  Widget dataBodyCategory() {
    return Theme(
      ...
      child: DataTable(
        ...
        rows: List.generate(rowDataCategory.length, (index) {
          final item = rowDataCategory[index];
          return DataRow(
            color: index % 2 == 0
