        ...
        if(key === arr[i]['filter_key']){
            for(let j in arr[i]['Branch']){
                if(branch_name === arr[i]['Branch'][j]['filter_key']){
                    return arr[i]['Branch'][j]['gp_gf_p3m_sum']
                }
            }
        }
                ...
                if(branch_name === arr[i]['Branch'][j]['filter_key']){
                    for(let k in arr[i]['Branch'][j]['Channel']){
                        if(channel_name === arr[i]['Branch'][j]['Channel'][k]['filter_key']){
                            return arr[i]['Branch'][j]['Channel'][k]['gp_gf_p3m_sum']
                        }
                    }
                }
            }
                        ...
                        if(channel_name === arr[i]['Branch'][j]['Channel'][k]['filter_key']){
                            for(let l in arr[i]['Branch'][j]['Channel'][k]['SubChannel']){
                                if(subChannel_name === arr[i]['Branch'][j]['Channel'][k]['SubChannel'][l]['filter_key']){
                                    return arr[i]['Branch'][j]['Channel'][k]['SubChannel'][l]['gp_gf_p3m_sum']
                                }
                            }
                        }
                    }
...
async function getTableData (bodyData){
    ...
    try {
        ...
        for (let i in all_data) {
            ...
            mergeObjAllIndia['gp_abs1'] =  final_result[0][0]['gp_gf_p3m_sum']
            mergeObjAllIndia['gp_abs2'] =  final_result[0][1]['gp_gf_p3m_sum']
            mergeObjAllIndia['gp_abs3'] =  final_result[0][2]['gp_gf_p3m_sum']
            ...
            for (let i in final_result[0][0]['division']) {
                ...
                if (!(div_key in mergeObjAllDivision)) {
                    mergeObjAllDivision[`${final_result[0][0]['division'][i]['filter_key']}`] = {
                        ...
                        'gp_abs1': final_result[0][0]['division'][i] ? final_result[0][0]['division'][i]['gp_gf_p3m_sum'] : 0,
                        'gp_abs2': final_result[0][1]['division'][i] ? final_result[0][1]['division'][i]['gp_gf_p3m_sum'] : 0,
                        'gp_abs3': final_result[0][2]['division'][i] ? final_result[0][2]['division'][i]['gp_gf_p3m_sum'] : 0,
                        'site': []
                    }
                }
                ...
                for (let j in final_result[0][0]['division'][i]['Site']) {
                    ...
                    let gp_abs1 = final_result[0][0]['division'][i] ? getMatchedValue(final_result[0][0]['division'][i]['Site'], site_key) : 0
                    let gp_abs2 = final_result[0][1]['division'][i] ? getMatchedValue(final_result[0][1]['division'][i]['Site'], site_key) : 0
                    let gp_abs3 = final_result[0][2]['division'][i] ? getMatchedValue(final_result[0][2]['division'][i]['Site'], site_key) : 0
                    mergeObjSite = {
                        'filter_key': site_key,
                        'gp_abs1': gp_abs1,
                        'gp_abs2': gp_abs2,
                    ...
                    for (let k in final_result[0][0]['division'][i]['Site'][j]['Branch']) {
                        ...
                        let gp_abs1 = final_result[0][0]['division'][i] ? getMatchedBranchValue(final_result[0][0]['division'][i]['Site'], site_key, branch_key) : 0
                        let gp_abs2 = final_result[0][1]['division'][i] ? getMatchedBranchValue(final_result[0][1]['division'][i]['Site'], site_key, branch_key) : 0
                        let gp_abs3 = final_result[0][2]['division'][i] ? getMatchedBranchValue(final_result[0][2]['division'][i]['Site'], site_key, branch_key) : 0
                        mergeObjBranch = {
                        ...
                        for (let l in final_result[0][0]['division'][i]['Site'][j]['Branch'][k]['Channel']) {
                            ...
                            let gp_abs1 = final_result[0][0]['division'][i] ? getMatchedChannelValue(final_result[0][0]['division'][i]['Site'], site_key, branch_key, channel_key) : 0
                            let gp_abs2 = final_result[0][1]['division'][i] ? getMatchedChannelValue(final_result[0][1]['division'][i]['Site'], site_key, branch_key, channel_key) : 0
                            let gp_abs3 = final_result[0][2]['division'][i] ? getMatchedChannelValue(final_result[0][2]['division'][i]['Site'], site_key, branch_key, channel_key) : 0
                            mergeObjChannel = {
                            ...
                            for (let m in final_result[0][0]['division'][i]['Site'][j]['Branch'][k]['Channel'][l]['SubChannel']) {
                                ...
                                let gp_abs1 = final_result[0][0]['division'][i] ? getMatchedSubChannelValue(final_result[0][0]['division'][i]['Site'], site_key, branch_key, channel_key, sub_channel_key) : 0
                                let gp_abs2 = final_result[0][1]['division'][i] ? getMatchedSubChannelValue(final_result[0][1]['division'][i]['Site'], site_key, branch_key, channel_key, sub_channel_key) : 0
                                let gp_abs3 = final_result[0][2]['division'][i] ? getMatchedSubChannelValue(final_result[0][2]['division'][i]['Site'], site_key, branch_key, channel_key, sub_channel_key) : 0
                                mergeObjSubChannel = {
...
let getDeepDivePageData = async (req, res) => {
    try {
        ...
        let cacheKey = 'gpMonthlyAbsDeepDiveData'
        let final_result = []
