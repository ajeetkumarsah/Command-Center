    ...
    try {
        ...
        for (let i in all_data) {
            ...
            for(let i in categories_data_rt_cy){
                cy_key[`${categories_data_rt_cy[i]['MonthYear']}/${categories_data_rt_cy[i]['Division']}`] = categories_data_rt_cy[i]['Retailing_Sum']
            }
            ...
            for(let i in categories_data_rt_py){
                ...
                if(!cy_key[`${monthYear}/${categories_data_rt_py[i]['Division']}`]){
                    let obj = {
                        'Retailing_Sum': 0,
                        'MonthYear': monthYear,
            ...
            console.log("FY Count:", financialYearCount)
