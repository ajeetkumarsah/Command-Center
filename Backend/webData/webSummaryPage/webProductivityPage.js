...
let getSummaryPageData = async (req, res) =>{
    try {
        ...
        // let new_producitivity_query_current_month = `select [Productive Calls] as productivity_calls, [Target Calls] as target_calls FROM [dbo].[tbl_command_center_productivity_calculation] where [${filter_key}] = '${filter_data}' and [Calendar Month] = '${calendar_month_cy}' and ChannelName is NULL`
